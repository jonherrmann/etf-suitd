...
/**
 * Initializes core objects. Adapter for the SoapUICore based on the command line runner SoapUICore.
 *
 * @author ole.matzura
 *
...
class IISoapUICore implements SoapUICore {
    ...
    /*
     * this method is added for enabling settings password (like in core) all the way down in hierarchy boolean
     * setingPassword is a dummy parameter, because the constructor with only one string parameter already existed
     */
